export const data = [
  {
    ...
    desc: "Burgers are a quintessential part of American cuisine, known for their delicious simplicity and versatility, as they can be customized with a range of toppings and sauces to suit individual tastes and preferences, making them a go-to meal for many people."
  },
  {
    id: 2,
  ...
  },
  {
    ...
    price: 4.2,
    location: 'Harison street',
    desc: "Pizza is a popular Italian dish, consisting of a flat dough base topped with tomato sauce, cheese, and a variety of toppings, enjoyed globally as a tasty and versatile meal option."
  },
  {
    id: 6,
    name: 'Supreme Pizza',
  ...
  },
  {
    ...
    price: 4.2,
    location: 'Beaker street Lane',
    desc: "Salad is a healthy dish made by combining fresh veggies, fruits, and protein, often topped with a dressing. It's a popular choice for a light and nutritious meal."
  },
  {
    id: 10,
    name: 'Ceasar Salad',
  ...
  },
  {
    ...
    price: 4.2,
    location: 'Gaksy Cafe',
    desc: "Chicken is a popular type of poultry enjoyed around the world for its lean protein, affordability, and versatility in cooking. Whether used in soups, salads, stir-fries, curries, or grilled and roasted dishes,"
  },
  {
    id: 14,
    name: 'Baked Chicken',
